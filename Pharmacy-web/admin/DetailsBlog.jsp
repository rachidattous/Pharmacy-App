                    ...
                    <div>
                          ...
                          <label class="label-input100" for="message">Title </label>
                            <div class="wrap-input100 validate-input" data-validate = "Message is required">
                                <input readonly id="title" class="input100" type="text" name="title" placeholder="Title" value="${bg.title}">
                                <span class="focus-input100"></span>
                            </div>
                                <textarea readonly style="resize:none" rows="15" cols="80" id="blog"  type="text" name="blog">${bg.blog}</textarea>
