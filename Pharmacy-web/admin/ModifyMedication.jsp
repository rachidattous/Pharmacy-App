        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div>
                        <form class="contact100-form validate-form" method="post" action="UpdateMedication.co">
                            <span class="contact100-form-title">
                                 Medication
                            </span>
                            <label class="label-input100" for="phone">Medication ID</label>
                            <div class="wrap-input100">
                                <input id="id_med" class="input100" type="text" name="id_med" value="${Med.id_medication}" readonly>
                                <span class="focus-input100"></span>
                            </div>
                            <label class="label-input100" for="phone">Name</label>
                            <div class="wrap-input100">
                                <input id="name" class="input100" type="text" name="name" value="${Med.name}" >
                                <span class="focus-input100"></span>
                            </div>
                             <label class="label-input100" for="phone">Price</label>
                            <div class="wrap-input100">
                                <input id="price" class="input100" type="text" name="price" value="${Med.price}" >
                                <span class="focus-input100"></span>
                            </div>
                             <label class="label-input100" for="phone">Description</label>
                            <div class="wrap-input100">
                                <input id="description" class="input100" type="text" name="description" value="${Med.description}" >
                                <span class="focus-input100"></span>
                            </div>
                            ...
                            <div class="wrap-input100 validate-input" data-validate = "Message is required">
                                <input id="picture" class="input100" type="file" name="picture" placeholder="Medication picture" value="${Med.image}">
                                <span class="focus-input100"></span>
                            </div>
