            ...
            <div class="row">
                <div class="col-lg-3">
                    <div class="hero__categories">
                        ...
                        <ul>
                            <li><a href="Medbycat.ph?cat=Rhume / nez bouché">Rhume / nez bouché</a></li>
                            <li><a href="Medbycat.ph?cat=maux de bouche">maux de bouche</a></li>
                            <li><a href="Medbycat.ph?cat=Premiers soins">Premiers soins</a></li>
                            <li><a href="Medbycat.ph?cat=Dermatologie / infections">Dermatologie / infections</a></li>
                            <li><a href="Medbycat.ph?cat=Digestion / troubles intestinaux">Digestion / troubles intestinaux</a></li>
                            <li><a href="Medbycat.ph?cat=Inflammation des muscles">Inflammation des muscles</a></li>
                            <li><a href="Medbycat.ph?cat=Nausées / vomissements">Nausées / vomissements</a></li>
                            <li><a href="Medbycat.ph?cat=Ophtalmologie / auriculaires">Ophtalmologie / auriculaires</a></li>
                            <li><a href="Medbycat.ph?cat=Anti-tabac / arrêter de fumer">Anti-tabac / arrêter de fumer</a></li>
